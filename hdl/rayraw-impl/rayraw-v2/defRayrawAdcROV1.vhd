...
-- GetTapValues ---------------------------------------------------------------------
  ...
  begin
    if (index = 0)  then
      return("10001", "01110", "10000", "01111", "01111", "01111", "01111", "10001", "01110");
    elsif (index = 1)  then
      return("10000", "01110", "01110", "01110", "01110", "10000", "01111", "01110", "01110");
    elsif (index = 2)  then
      return("01111", "01111", "10000", "01111", "01111", "01111", "01111", "10000", "01110");
    else
      return("10000", "01110", "01110", "01110", "01111", "01111", "01111", "10000", "10000");
    end if;
